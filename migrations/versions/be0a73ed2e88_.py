...
Revision ID: be0a73ed2e88
Revises: 
Create Date: 2021-02-25 20:23:54.639660
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['receiving_user_id'], ['users.id'], ondelete='cascade'),
